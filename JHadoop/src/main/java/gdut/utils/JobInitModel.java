...
public class JobInitModel {
    ...
    public JobInitModel(String[] inPaths, String outPath, Configuration conf, Job job, String jobName, Class<?> jarClass,
                        Class<? extends InputFormat> inputFormatClass,
                        Class<? extends Mapper> mapper, Class<?> mapOutKeyClass, Class<?> mapOutValueClass,
                        Class<? extends Partitioner> partitionerClass, Class<? extends Reducer> combiner,
        ...
        this.inputFormatClass = inputFormatClass;  //default
        this.mapper = mapper;
